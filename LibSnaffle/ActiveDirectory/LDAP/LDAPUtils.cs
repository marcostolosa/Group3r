...
namespace LibSnaffle.ActiveDirectory.LDAP
{
    public class LDAPUtils
    {
        ...
        private static readonly ConcurrentDictionary<string, ResolvedWKP> SeenWellKnownPrincipals = new ConcurrentDictionary<string, ResolvedWKP>();
        private static readonly ConcurrentDictionary<string, byte> DomainControllers = new ConcurrentDictionary<string, byte>();

        private readonly ConcurrentDictionary<string, Domain> _domainCache = new ConcurrentDictionary<string, Domain>();
        private readonly ConcurrentDictionary<string, string> _domainControllerCache = new ConcurrentDictionary<string, string>();

        private readonly ConcurrentDictionary<string, LdapConnection> _globalCatalogConnections = new ConcurrentDictionary<string, LdapConnection>();
        private readonly ConcurrentDictionary<string, string> _hostResolutionMap = new ConcurrentDictionary<string, string>();
        private readonly ConcurrentDictionary<string, LdapConnection> _ldapConnections = new ConcurrentDictionary<string, LdapConnection>();
        private readonly NativeMethods _nativeMethods;
        private readonly ConcurrentDictionary<string, string> _netbiosCache = new ConcurrentDictionary<string, string>();
        //private readonly PortScanner _portScanner;
        private LDAPConfig _ldapConfig = new LDAPConfig();
